...
-- The OUTER join are:
-- 	The LEFT JOIN -> all the records on the LEFT table are returned, whether the condition is true or not
-- 	The RIGHT JOIN -> all the records on the Right table are returned, whether the condition is true or not
